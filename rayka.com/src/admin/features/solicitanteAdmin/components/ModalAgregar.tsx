...
type Props = {
  open: boolean;
  onClose: () => void;
  onSave: (solicitante: CrearSolicitanteRequest) => Promise<void> | void;
  loading?: boolean;
  empresas: Empresa[];
};

export default function ModalAgregar({ open, onClose, onSave, loading, empresas }: Props) {
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative z-[61] w-full max-w-lg mx-4 rounded-xl bg-white shadow-xl border border-slate-200">
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200">
          <h3 className="text-base font-semibold text-slate-900">Nuevo Solicitante</h3>
          <button
            onClick={onClose}
